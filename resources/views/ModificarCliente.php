...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          <li ><a href="CrearCliente"><i class="bx bx-user"></i> <span>Registrar Clientes</span></a></li>
          <li class="active"><a href="#"><i class="bx bx-file-blank"></i> <span>Modificar Clientes</span></a></li>
